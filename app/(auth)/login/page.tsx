...
// Build-Datum wird zur Build-Zeit generiert (nicht bei jedem Seitenaufruf)
// NEXT_PUBLIC_BUILD_DATE wird in next.config.ts gesetzt
const BUILD_DATE = process.env.NEXT_PUBLIC_BUILD_DATE || "16.01.2026";
